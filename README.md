...
![2025-05-21_21 35 59](https://github.com/user-attachments/assets/57390dec-f9b2-429e-9def-8fa27f9a6bbd)
Почему такой результат? Скорее всего из-за того, что OptiCool использует оптимизированные варианты настроек, которые придают вид Minecraft на Детальном графике, хотя это Быстрая, а также исправляет большие проблемы с лагами от частиц.
